export default function WarningQuotaMonthly() {
  return (
    <div className="group relative flex w-6 h-6 justify-center items-center rounded-md font-bold bg-red-600 text-white">
      ...
      <div className="absolute bottom-full left-1/2 transform -ml-1 -translate-x-1/2 mb-1 h-25 w-35 px-4 py-3 rounded-md bg-red-600 opacity-0 group-hover:opacity-100 transition-opacity"></div>
      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-1 h-25 w-35 px-3 py-4 rounded-md bg-rose-100 text-black text-s font-normal opacity-0 group-hover:opacity-100 transition-opacity">
